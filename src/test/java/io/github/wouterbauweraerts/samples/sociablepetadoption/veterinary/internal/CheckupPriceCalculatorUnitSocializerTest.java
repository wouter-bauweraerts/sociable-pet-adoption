...
@SociableTest
class CheckupPriceCalculatorUnitSocializerTest {
    @TestSubject
    ...
    @Predefined
    Clock clock = Clock.fixed(LocalDateTime.of(2025, 10, 12, 11, 12, 13, 456).toInstant(ZoneOffset.UTC), ZoneId.systemDefault());
